...
if ( ! class_exists( Plugin_Data::class ) ) {
	...
	class Plugin_Data {
		 ...
		 * Example: /app/public/wp-content/plugins/tk-timestamp-to-human/
		 *
		 * @return string
		 */
		 ...
		 *
		 * Example: https://example.com/wp-content/plugins/tk-timestamp-to-human/
		 *
		 * @return string
		 */
		 ...
		 *
		 * @return string 'tk-timestamp-to-human/tk-timestamp-to-human.php'
		 */
